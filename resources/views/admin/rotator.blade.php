    ...
    <x-layout_admin_staff>
        ...
        <div class="alert alert-warning" role="alert">
            ...
            <ul class="mb-0">
                ...
                <li>2. Setelah melakukan pencarian klik tombol <strong>‘refresh’</strong> untuk menampilkan semua data
                    yang tersedia.</li>
            </ul>
        </div>
        <div class="row">
                ...
                <div class="card-body">
                    <form>
                        ...
                        <div class="text-center">
                            <a href="{{ route('rotator.showLink') }}" class="btn btn-primary" target="_blank"
            ...
            <!-- Modal Edit -->
            <div class="modal fade" id="formModal2" tabindex="-1" aria-labelledby="formModalLabel"
                aria-hidden="true">
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header">
...
@elseif(auth()->user()->role == 'super admin')
    <x-layout_admin>
        ...
        <div class="row">
                                    ...
                                    @foreach ($nomors as $index => $user)
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <form action="{{ route('rotator.destroy', $user->id) }}"
            ...
            <div class="card mb-0">
                <div class="card-body">
                    <form>
                        ...
                        <div class="position-fixed bottom-0 end-0 p-3" style="z-index: 11">
                            <div id="copyToast" class="toast" role="alert" aria-live="assertive"
                                aria-atomic="true">
                                <div class="toast-body">
                                    <i class="fas fa-check-circle text-success"></i> Teks berhasil disalin!
                                </div>
            ...
            <!-- Modal Add -->
            <div class="modal fade" id="formModal1" tabindex="-1" aria-labelledby="formModalLabel"
                aria-hidden="true">
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header">
