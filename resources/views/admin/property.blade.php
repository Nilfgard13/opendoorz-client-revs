        ...
        <div class="alert alert-warning" role="alert">
            ...
            <ul class="mb-0">
                <li>1. Semua fitur upload hanya di setting untuk upload 1 gambar. Untuk fitur upload gambar pada
                    ...
                    tombol silang pada pojok gambar lalu anda bisa upload gambar.
                </li>
                <li>2. Pengisian alamat cukup dengan nama jalan saja (Jl. Puri Indah No. 45), karena kolom nama kota
                    sudah
                    disediakan
                    terpisah namun anda bisa mengisikan data selain data kota.</li>
                <li>3. Tersedia manajemen kategori berdasarkan tipe perumahan dan kategori berdasarkan kota untuk
                    penambahan
                ...
                <li>5. Hanya data yang berstatus <strong>‘available’</strong> yang akan ditampilkan pada tampilan
                    landing
                    page.</li>
                <li>6. Setelah melakukan pencarian klik tombol <strong>‘refresh’</strong> untuk menampilkan semua data
                    yang
                    tersedia.</li>
            </ul>
        </div>
                    ...
                    <div class="card-body">
                        ...
                        <table class="table">
                            ...
                            <tbody>
                                @if ($property->isEmpty())
                                    <tr>
                                        <td colspan="7" class="text-center text-muted">❌ Tidak ada data ditemukan
                                        </td>
                                    </tr>
                                @else
                                    @foreach ($property as $index => $user)
                                        <tr class="toggle-row" data-target="details{{ $index }}">
                                            ...
                                            <td>
                                                ...
                                                <form action="{{ route('property.destroy', $user->id) }}"
                                        ...
                                        <tr class="toggle-row" data-target="details{{ $index }}">
                                            ...
                                            <td>
                                                ...
                                                <form action="{{ route('property.destroy', $user->id) }}"
                                                    ...
                                                    @method('DELETE')
                                                    <button type="submit"
                                                        class="btn btn-outline-danger m-1 delete-btn"
                                                        onclick="return confirm('Apakah Anda yakin ingin menghapus properti ini?')">
                                                        Delete
                                                    </button>
                                                </form>
