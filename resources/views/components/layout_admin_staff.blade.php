...
<body>
                ...
                <nav class="navbar navbar-expand-lg navbar-light">
                    ...
                    <div class="navbar-collapse justify-content-end px-0" id="navbarNav">
                        <ul class="navbar-nav flex-row ms-auto align-items-center justify-content-end">
                            <a href="#" target="_blank" class="btn btn-primary">{{ Auth::user()->username }} ({{ Auth::user()->role }})</a>
    ...
    {{-- <script>
        fetch("{{ route('user.data') }}", {
            ...
            .then(data => {
                if (data.user) { // Cek apakah user ada
                    document.getElementById("user-button").textContent = `${data.user.name} - ${data.user.role}`;
                } else {
                    document.getElementById("user-button").textContent = "No User Data";
                }
            })
            .catch(error => {
                console.error('Error:', error);
                document.getElementById("user-button").textContent = "Failed to Load";
            });
    </script> --}}
